...
local Window = OrionLib:MakeWindow({Name = "REY MARABINI POGI HUB", HidePremium = true, SaveConfig = true, ConfigFolder = "Shar Script",IntroText = "PORNHUB",IntroIcon = ""})

local Players = game:GetService("Players").LocalPlayer
OrionLib:MakeNotification({
	Name = "Nigger baby Script",
	Content = "Welcome Slave"..Players.Name.."!",
	Image = "rbxassetid://",
	Time = 5
})
...
Tab:AddParagraph("Slave :",Players.Name)
...
Tab:AddParagraph("Version :", "V69")

Tab:AddParagraph("Last Update :", "01/01/2023")
local Section = Tab:AddSection({
	Name = "Developper Information"
})
Tab:AddParagraph("Scripter :", "NIGGER BABIES")

Tab:AddParagraph("My Discord :", "discord.gg/NIGGER")

Tab:AddParagraph("CAMBIE :", "SECONDARY SCHOOL")
...
Tab:AddButton({
	Name = "Goto Dealer - METHOD",
	Callback = function()
      	    game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(5, Enum.EasingStyle.Linear), {CFrame = CFrame.new(-1.92548966, -8.76463604, -24.845953, -0.229749665, -8.13815682e-09, 0.973249733, -1.02916864e-07, 1, -1.59331766e-08, -0.973249733, -1.03824455e-07, -0.229749665)}):Play()
  	end    
})

Tab:AddButton({
	Name = "Goto Jewelry store - METHOD",
	Callback = function()
	    game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(5, Enum.EasingStyle.Linear), {CFrame = CFrame.new(577.503418, 3.86086893, -198.133072, -0.47910431, 4.12645456e-08, 0.877757967, 7.75305775e-09, 1, -4.27794724e-08, -0.877757967, -1.36905207e-08, -0.47910431)}):Play()
	end    
})
...
Tab:AddButton({
	...
	Callback = function()
		game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(11, Enum.EasingStyle.Linear), {CFrame = CFrame.new(153, 3, -364)}):Play()
	end    
})
...
Tab:AddButton({
	...
	Callback = function()
		game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(11, Enum.EasingStyle.Linear), {CFrame = CFrame.new(298.92572, 3.22447729, -368.483002, 0.0241038762, -3.68269646e-08, -0.999709487, 1.07089342e-07, 1, -3.4255649e-08, 0.999709487, -1.06232534e-07, 0.0241038762)}):Play()
	end    
})
...
Tab:AddButton({
	Name = "Goto Hospital",
	Callback = function()
		game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(11, Enum.EasingStyle.Linear), {CFrame = CFrame.new(417, 3, -362)}):Play()
	end    
})
...
Tab:AddButton({
	...
	Callback = function()
		game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(11, Enum.EasingStyle.Linear), {CFrame = CFrame.new(-403, 3, -38)}):Play()
	end    
})
...
Tab:AddButton({
	...
	Callback = function()
		game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(11, Enum.EasingStyle.Linear), {CFrame = CFrame.new(-114, 3, -188)}):Play()
	end    
})
...
Tab:AddButton({
	...
	Callback = function()
		game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(11, Enum.EasingStyle.Linear), {CFrame = CFrame.new(-57, 3, -33)}):Play()
	end    
})
...
Tab:AddButton({
	Name = "Goto Gun Shop",
	Callback = function()
	    game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(11, Enum.EasingStyle.Linear), {CFrame = CFrame.new(117, 3, 47)}):Play()
	end    
})
...
Tab:AddButton({
	...
	Callback = function()
	    game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(11, Enum.EasingStyle.Linear), {CFrame = CFrame.new(588, 4, -75)}):Play()
	end    
})
...
Tab:AddButton({
	Name = "Goto The Pitch",
	Callback = function()
	    game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(11, Enum.EasingStyle.Linear), {CFrame = CFrame.new(709, 3, -96)}):Play()
	end    
})
...
Tab:AddButton({
	Name = "Goto Bike Shop",
	Callback = function()
	    game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(11, Enum.EasingStyle.Linear), {CFrame = CFrame.new(743, 3, -208)}):Play()
	end    
})
...
Tab:AddButton({
	...
	Callback = function()
	    game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(11, Enum.EasingStyle.Linear), {CFrame = CFrame.new(-9, -9, -26)}):Play()
	end    
})
...
Tab:AddButton({
	...
	Callback = function()
	    game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(11, Enum.EasingStyle.Linear), {CFrame = CFrame.new(742, 1, -215)}):Play()
	end    
})
...
Tab:AddButton({
	...
	Callback = function()
	    game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(11, Enum.EasingStyle.Linear), {CFrame = CFrame.new(122, 3, 47)}):Play()
	end    
})
...
Tab:AddButton({
	Name = "Goto Deli NPC",
	Callback = function()
	    game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(11, Enum.EasingStyle.Linear), {CFrame = CFrame.new(-68, 3, 59)}):Play()
	end    
})
...
Tab:AddButton({
	...
	Callback = function()
	    game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(15, Enum.EasingStyle.Linear), {CFrame = CFrame.new(234, 3, -181)}):Play()
	end    
})
...
Tab:AddButton({
	...
	Callback = function()
	    game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(11, Enum.EasingStyle.Linear), {CFrame = CFrame.new(338, 3, -40)}):Play()
	end    
})
...
Tab:AddButton({
	...
	Callback = function()
	    game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(11, Enum.EasingStyle.Linear), {CFrame = CFrame.new(643, 3, 82)}):Play()
	end    
})
Tab:AddButton({
	Name = "Goto In-N-Out NPC",
	Callback = function()
	    game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(11, Enum.EasingStyle.Linear), {CFrame = CFrame.new(590, 7, -84)}):Play()
	end    
})
...
Tab:AddButton({
	...
	Callback = function()
		...
		game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(10, Enum.EasingStyle.Linear), {CFrame = CFrame.new(-6.207057, -9.37552357, -19.0183372, -0.682898045, -1.9579824e-08, 0.730513692, -1.45859325e-10, 1, 2.66664646e-08, -0.730513692, 1.81039237e-08, -0.682898045)}):Play()
		wait(0.5)
...
Tab:AddToggle({
    ...
    Callback = function(Value) 
		...
		-------
			game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(10, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {CFrame = CFrame.new(-76, 3, 61)}):Play()
			wait()
...
Tab:AddToggle({
    ...
    Callback = function(Value) 
		...
		game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(10, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {CFrame = CFrame.new(-249, 3, -47)}):Play();
		...
		spawn(function()
			while _G.Settings.Autorob do
				...
				if moneybag then
					...
					game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(10, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {CFrame = CFrame.new(0, -10, 0)}):Play()
				end
				wait()
			end
		end)
